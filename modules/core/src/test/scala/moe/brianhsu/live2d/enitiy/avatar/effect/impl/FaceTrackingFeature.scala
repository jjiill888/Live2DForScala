  ...
  Feature("Calculate the face tracking operations") {
    ...
    Scenario("There are 12 tracking nodes") {
      ...
      val trackingNodes = List(
        TrackingNode(0.01f, 0.02f, 0.03f, 0.04f, 0.05f, 0.06f, 0.07f, 0.08f, 0.09f, 0f, 0f),
        TrackingNode(0.11f, 0.12f, 0.13f, 0.14f, 0.15f, 0.16f, 0.17f, 0.18f, 0.19f, 0f, 0f),
        TrackingNode(0.21f, 0.22f, 0.23f, 0.24f, 0.25f, 0.26f, 0.27f, 0.28f, 0.29f, 0f, 0f),
        TrackingNode(0.31f, 0.32f, 0.23f, 0.34f, 0.35f, 0.36f, 0.37f, 0.38f, 0.39f, 0f, 0f),
        TrackingNode(0.41f, 0.42f, 0.43f, 0.44f, 0.45f, 0.46f, 0.47f, 0.48f, 0.49f, 0f, 0f),
        TrackingNode(0.51f, 0.52f, 0.53f, 0.54f, 0.55f, 0.56f, 0.57f, 0.58f, 0.59f, 0f, 0f),
        TrackingNode(0.61f, 0.62f, 0.63f, 0.64f, 0.65f, 0.66f, 0.67f, 0.68f, 0.69f, 0f, 0f),
        TrackingNode(0.71f, 0.72f, 0.73f, 0.74f, 0.75f, 0.76f, 0.77f, 0.78f, 0.79f, 0f, 0f),
        TrackingNode(0.81f, 0.82f, 0.83f, 0.84f, 0.85f, 0.86f, 0.87f, 0.88f, 0.89f, 0f, 0f),
        TrackingNode(0.91f, 0.92f, 0.93f, 0.94f, 0.95f, 0.96f, 0.97f, 0.98f, 0.99f, 0f, 0f),
        TrackingNode(1.01f, 1.02f, 1.03f, 1.04f, 1.05f, 0.16f, 1.07f, 1.08f, 1.09f, 0f, 0f),
        TrackingNode(1.11f, 1.12f, 1.13f, 1.14f, 1.15f, 1.16f, 1.17f, 1.18f, 1.19f, 0f, 0f),
      )
