...
cp -v modules/examples/swing/target/scala-3/Live2DForScala-Swing-*.jar Live2DForScala-Swing/Live2DForScala-Swing-${version}.jar

mkdir Live2DForScala-SWT-Linux
cp -rf openSeeFace Live2DForScala-SWT-Linux/
cp -v modules/examples/swt-linux-bundle/target/scala-3/Live2DForScala-SWT-Linux-*.jar Live2DForScala-SWT-Linux/Live2DForScala-SWT-Linux-${version}.jar

mkdir Live2DForScala-SWT-Windows
cp -rf openSeeFace Live2DForScala-SWT-Windows
cp -v modules/examples/swt-windows-bundle/target/scala-3/Live2DForScala-SWT-Windows-*.jar Live2DForScala-SWT-Windows/Live2DForScala-SWT-Windows-${version}.jar
